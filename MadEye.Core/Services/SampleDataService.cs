            ...
            new SampleCompany()
            {
                ...
                Orders = new List<SampleOrder>()
                {
                    new SampleOrder()
                    {
                        ...
                        Freight = 29.46,
                        Company = "KeyStrokes",
                        ShipTo = "KeyStrokes, Obere Str. 57, Berlin, 12209, Germany",
                        OrderTotal = 814.50,
                        Status = "Shipped",
                        SymbolCode = 57643,
                        SymbolName = "Globe",
                    ...
                    new SampleOrder()
                    {
                        ...
                        Freight = 69.53,
                        Company = "Screenshots",
                        ShipTo = "Screenshots, Obere Str. 57, Berlin, 12209, Germany",
                        OrderTotal = 845.80,
                        Status = "Closed",
                        SymbolCode = 57737,
                        SymbolName = "Audio",
                    ...
                    new SampleOrder()
                    {
                        ...
                        Freight = 40.42,
                        Company = "WebCam",
                        ShipTo = "WebCam, Obere Str. 57, Berlin, 12209, Germany",
                        OrderTotal = 471.20,
                        Status = "Closed",
                        SymbolCode = 57699,
                        SymbolName = "Camera",
            ...
            new SampleCompany()
            {
                ...
                Orders = new List<SampleOrder>()
                {
                    new SampleOrder()
                    {
                        ...
                        ShipTo = "Internet Activity, Avda. de la Constitución 2222, 05021, México D.F., Mexico",
                        OrderTotal = 469.75,
                        Status = "Shipped",
                        SymbolCode = 57620,
                        SymbolName = "Clock",
                    ...
                    new SampleOrder()
                    {
                        ...
                        ShipperPhone = "(503) 555-9931",
                        Freight = 39.92,
                        Company = "File Explorer",
                        ShipTo = "File Explorer, Avda. de la Constitución 2222, 05021, México D.F., Mexico",
                        OrderTotal = 507.20,
                        Status = "Shipped",
                        SymbolCode = 57633,
                        SymbolName = "Calender",
